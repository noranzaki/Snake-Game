...
const changeFoodPosition = () => {
    foodY = Math.floor(Math.random() * (playBoardWidth / 30)) + 2;// we used 30 here cuz is CSS we specified the num of rows&cols with 30
    foodX = Math.floor(Math.random() * (playBoardHeight / 30)) + 2; 
  };
const initGame = () => {
